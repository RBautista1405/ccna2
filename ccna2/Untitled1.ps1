...
!!!DAPAT 7 UNDER52SCORE ANG NA EDIT MO  ( LINE 34 to 68 PASTE TO COREBABA SWITCH )
!@@@LeafSwitchONLY
config t
...
conf t
 ...
 NO ip route 10.52.0.0 255.255.0.0 200.0.0.52
...
!
telephony-service
 moh "flash:/en52bacd52music52on52hold.au"
!
application
 service rivanaa flash:app-b-acd-aa-3.0.0.2.tcl
  ...
  param welcome-prompt flash:en52bacd52welcome.au
...
http://docwiki.cisco.com/wiki/Cisco52IOS52Voice52Troubleshooting52and52Monitoring52--52Tcl52IVR52Troubleshooting
...
!
  voice register pool 1
    id mac 9c73.b125.96d5
    number 1 dn 1
    dtmf-relay sip-notify
    username 5251 password 5251
    codec g711ulaw
!
  voice register pool 2
    id mac 5252.5252.5252
    number 1 dn 2
    dtmf-relay sip-notify
    username 5252 password 5252
    codec g711ulaw
!
